...
module.exports = {
  ...
  siteDescriptionHtml:
    "<b>whatsonchain.com - Bitcoin SV Blockchain Explorer</b> is <a href='whatsonchain.com).",
  ...
  currencyUnitsByName: {
    BSV: btcCurrencyUnits[0],
    mBSV: btcCurrencyUnits[1],
    bits: btcCurrencyUnits[2],
  ...
  historicalData: [
    {
      ...
      alertBodyHtml:
        "This is the first block in the Bitcoin blockchain, known as the 'Genesis Block'. This block was mined by Bitcoin's creator Satoshi Nakamoto. You can read more about <a href='https://en.bitcoin.it/wiki/Genesis_block'>the genesis block</a>.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "In this first-known BTC-to-fiat transaction, 5,050 BTC were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/BTC.",
    ...
    },
    {
      ...
      referenceUrl:
        "https://www.reddit.com/r/Bitcoin/comments/7mhoks/til_in_2011_a_user_running_a_modified_mining/"
    },
    {
      type: "blockheight",
      date: "2009-01-12",
      ...
      alertBodyHtml:
        "This block comes 9 days after the genesis block and is the first to contain a transfer of bitcoin. Before this block all blocks contained only coinbase transactions which mint new bitcoin.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "This coinbase transaction completely fails to collect the block's mining reward. 12.5 BTC were lost.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "This address was generated from the SHA256 hash of 'Satoshi Nakamoto' as example of the 'brainwallet' concept."
    }
  ],
  exchangeRateData: {
